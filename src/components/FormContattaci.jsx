...
const ContactForm = () => {
  ...
  return (
    <div className="bg-[#808473] min-h-screen flex items-center justify-center p-6">
      <div className="bg-white shadow-lg rounded-lg p-6 md:w-[70%] mx-auto max-w-full">
        {status === "success" ? (
          <div className="text-center">
            ...
            <img
              src="https://www.example.com/thank-you-image.jpg" // Sostituisci con l'immagine che preferisci
              alt="Thank You"
          ...
          <div>
            <h2 className="text-2xl font-bold text-center text-gray-800 mb-6">Contattaci</h2>
