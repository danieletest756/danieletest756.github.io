...
const teamMembers = [
    { name: "Vladimiro Piastra", role: "Pianificazione Produzione e Sviluppo Nuovi Prodotti", img:  dipendente1}, 
    { name: "Yuri Andrea Piastra", role: "Socio e ingegnere meccanico, progettista innovativo.", img: dipendente7 },
    { name: "Veronica Piastra", role: "Amministratrice, laureata in Scienza dell'Architettura.", img: dipendente3 },
    { name: "Adrian Tujan", role: "Specialista in saldatura, tornitura e carpenteria.", img: dipendente2 },  
    { name: "Isidoro Lagonegro", role: "Progettista Meccanico, Esperto in Tecnologie CNC", img: dipendente4 },
    { name: "Severino Fiorentini", role: "", img: dipendente5 },
    { name: "Michele Lepore", role: "Capo officina, esperto in lavorazioni CNC.", img: dipendente6 },
    { name: "Valerio Vallucci", role: "Giovane talento, esperto in pantografo, laser e lavorazioni plastiche.", img: dipendente8 }
  ];
